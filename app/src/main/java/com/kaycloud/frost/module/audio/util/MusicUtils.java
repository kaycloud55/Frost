...
import com.kaycloud.frost.module.audio.Music;
...
public class MusicUtils {
    ...
    private static final String[] formatSet =
            new String[]{".mp3", ".wav", ".wma", ".ogg", ".m4a", ".opus", ".flac", ".aac"};
    ...
    private static boolean isIntentAvailable(Context context, Intent intent) {
        return context.getPackageManager()
                .resolveActivity(intent, PackageManager.GET_RESOLVED_FILTER) != null;
    }
